...
#https://stackoverflow.com/questions/50573658/python-google-places-api
...
def findPlaces(loc=("35.701474", "51.405288"), radius=4000, pagetoken=None):
    ...
    url = "https://maps.googleapis.com/maps/api/place/nearbysearch/json?location={lat},{lng}&radius={radius}&type={type}&key={APIKEY}{pagetoken}".format(
        lat=lat, lng=lng, radius=radius, type=type, APIKEY=APIKEY,
...
def get_amfam_locations(latitude, longitude, radius):
    """
    get_amfam_locations gets a list of amfam locations within a specific radius around coordinates
